FILES :=                        \
    life-tests/fc6439-RunLife.out  \
    life-tests/fc6439-TestLife.c++ \
    life-tests/fc6439-TestLife.out \
    Life.c++                    \
    Life.h                      \
    Life.log                    \
    html                        \
...
TestLife: Life.h TestLife.c++ AbstractCell.h AbstractCell.c++ Cell.h Cell.c++ ConwayCell.h ConwayCell.c++ FredkinCell.h FredkinCell.c++
